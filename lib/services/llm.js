...
You have been given extracted content from multiple documents below.

Your job has TWO phases:

PHASE 1 — Extract: For EACH document, read its content carefully and summarize what it says that is relevant to the user's question. Report this clearly under the document name. If a document's content genuinely has nothing related to the question topic, only then say "No relevant information found."

PHASE 2 — Answer & Compare: After summarizing each document, directly answer the user's question using what you found. If the question asks whether one document mentions something from another, check the actual content and give a clear yes/no with supporting evidence.

Rules:
- Use the format "**[Document Name]:**" as a heading for each document's findings
- Base your answer ONLY on the content provided — never invent or assume
- Do NOT say "No relevant information found" if the document content actually contains related information
- After all documents, add a "**Summary:**" with key findings or differences
