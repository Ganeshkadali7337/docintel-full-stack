...
async function extractFromPDF(buffer) {
  ...
  try {
    // Run text extraction and info fetch sequentially — same parser instance
    ...
    return { text, pageCount: infoResult.total || null, error: null, warnings };
  } catch (error) {
...
async function extractFromDOCX(buffer) {
  try {
    ...
    // Collect mammoth warnings but don't fail — partial extraction is fine
